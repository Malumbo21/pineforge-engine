...
//   * on the bar whose incoming source swallows the carried compensation
//     (c != 0 and fl(x - c) == x), the sum is re-summed newest-first over the
//     window's sources and c is reset.
//
